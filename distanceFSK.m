...
% Title: FSK modulation for bistatic backscatter communications with BER in
% terms of distance 
...
F1= 900*10^6;           
Fc=867*10^6;                                                                %carrier frequency
T=1/1000; %bit period for bitrate = 1kbps
Fs= 10000;
Ts=1/Fs;    
L = T/Ts;                                                                   %L taps

d = randi([0,1],[1,num_bit]);                                               %random bit sequence
distance = 1:1:48;                                                          %distance incrementation
limit= max(distance);                                                       %Range value
